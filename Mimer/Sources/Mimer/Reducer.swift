...
public struct IdentityReducer<State, Action>: Reducer {
    public func reduce(oldState: State, with _: Action) -> State {
        oldState
    }
}
...
public extension Reducer {
    ...
    func lifted<LiftedState, LiftedAction>(
    ...
    func keyed<KeyedState, KeyedAction, Key: Hashable>(
    ...
    func offset<OffsetState, OffsetAction>(
    ...
    func optional() -> some Reducer<State?, Action> {
